...
class PowerGridScaler(Scaler):
    ...
    def get_all_m_sd(self):
        return self._m_x,self._sd_x,self._m_y,self._sd_y,self._m_tau,self._sd_tau
    ...
    def inverse_x_transform(self, x):
        ...
        print("================X===============")
        print(x)
        for attr_nm, arr_, m_, sd_ in zip(self._attr_x, x, self._m_x, self._sd_x):
            res[attr_nm] = (arr_ * sd_) + m_
        return res
